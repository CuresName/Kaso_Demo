...
const DEFAULT_MESSAGES = [
  {
    role: "ai",
    text: "嗨，我會記住這段對話的主要問題。你可以問我：今天還能花多少、旅遊怎麼分配，或貼商品連結讓我一起比較。",
  },
];
...
export const state = {
  ...
  searchQuery: "",
  searchCategory: "商品",
  // 比價結果快取：離開頁面再回來不重打 BigGo
  search: { status: "idle", query: "", result: null, error: null },
  transactions: [],
  // 附近優惠結果快取
  nearby: { status: "idle", coords: null, source: null, stores: [], activities: [], cultureStores: [], error: null, budgetOnly: false },
  recovery: null,
